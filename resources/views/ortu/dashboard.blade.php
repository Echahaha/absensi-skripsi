    ...
    <style>
        ...
        * {
        ...
        @media (min-width: 768px) {
            ...
            .status-banner.terlambat {
                background: var(--yellow-light);
                border: 1.5px solid #fcd34d;
            }

            .status-banner.tidak-hadir {
    ...
    <div class="desktop-layout">
        ...
        <aside class="sidebar">
            <div class="sidebar-brand">
                <div class="sidebar-brand-title"><i class="fas fa-graduation-cap me-2"
                        style="color:var(--blue-primary)"></i>Portal Wali</div>
            ...
            <div class="sidebar-footer">
                ...
                <a href="#" class="btn-logout-web mt-3 w-100 justify-content-center" data-bs-toggle="modal"
        ...
        <main class="main-content">
            ...
            <div class="topbar">
                <div>
                    ...
                    <div class="page-subtitle">Selamat datang, Wali dari <strong>{{ $mahasiswa->nama_lengkap }}</strong>
                    </div>
                </div>
            ...
            <div class="content-grid">
                ...
                <div class="web-card">
                    <div class="web-card-header">
                        <span class="web-card-title"><i class="fas fa-list-ul me-2"
                                style="color:var(--blue-primary)"></i>Riwayat Kehadiran</span>
                        <a href="{{ route('ortu.riwayat') }}"
                            style="font-size:13px; font-weight:700; color:var(--blue-primary); text-decoration:none;">
                ...
                <div>
                    <div class="web-card">
                        <div class="web-card-header">
                            <span class="web-card-title"><i class="fas fa-calendar-day me-2"
                                    style="color:var(--blue-primary)"></i>Status Hari Ini</span>
                        </div>
                        <div style="padding:24px;">
                            ...
                            {{-- Info mahasiswa --}}
                            <div
                                style="background:var(--gray-50); border-radius:12px; padding:16px; border:1px solid var(--gray-200); margin-top:16px;">
                                <div
                                    style="font-size:11px; text-transform:uppercase; letter-spacing:.06em; color:var(--gray-400); font-weight:700; margin-bottom:10px;">
                                    Info Mahasiswa</div>
                                <div style="display:flex; align-items:center; gap:12px;">
                                    <div
                                        style="width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,var(--blue-primary),var(--blue-dark));color:white;font-weight:800;font-size:18px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                        {{ substr($mahasiswa->nama_lengkap, 0, 1) }}
                                    </div>
                                    <div>
                                        <div style="font-weight:700; font-size:14px;">{{ $mahasiswa->nama_lengkap }}
                                        </div>
                                        <div style="font-size:12px; color:var(--gray-400); font-weight:500;">NIM:
                                            {{ $mahasiswa->nim }}
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="app-wrapper">
            ...
            <div class="header-app">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <small class="d-block fw-semibold mb-1" style="color:rgba(255,255,255,.65);">Selamat Datang,
                            Wali dari</small>
            ...
            <div class="px-3">
                <div class="card card-status mb-4">
                    <div class="card-body text-center py-4 px-3">
                        <p class="text-secondary fw-semibold mb-2" style="font-size:12px;text-transform:uppercase;">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('ortu.riwayat') }}" class="text-decoration-none small fw-bold"
                        style="color:var(--blue-primary)">Lihat Semua</a>
                </div>
