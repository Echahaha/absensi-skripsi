...
<div class="desktop-layout">
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <div class="page-title">Tambah Mahasiswa Baru</div>
                <div class="page-subtitle">Isi formulir di bawah dengan data yang valid</div>
            </div>
        </div>
            ...
            <form action="{{ route('mahasiswa.store') }}" method="POST">
                ...
                <div class="web-card-body">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
                        <div>
                            <label class="form-label-web">NIM <span style="color:var(--red)">*</span></label>
                            <input type="number" name="nim"
                                class="form-control-web {{ $errors->has('nim') ? 'is-invalid' : '' }}"
                                placeholder="Contoh: 2025001" required value="{{ old('nim') }}">
                    ...
                    <div style="margin-bottom:16px;">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control-web"
                            placeholder="Masukkan nama lengkap sesuai KTP/KTM" required value="{{ old('nama_lengkap') }}">
                    ...
                    <div class="hardware-box">
                        <div class="hardware-box-title">
                            <i class="fas fa-microchip"></i> Konfigurasi Sistem & Notifikasi
                        </div>

                        <div style="margin-bottom:16px;">
                            <label class="form-label-web" style="color:var(--gray-800);">
                                ID Fingerprint <span style="color:var(--red)">*</span>
                            </label>
                            <div class="input-group-web {{ $errors->has('fingerprint_id') ? 'is-invalid' : '' }}">
                                <span class="input-group-prefix" style="color:var(--blue-primary);">
                                    <i class="fas fa-fingerprint"></i>
                                </span>
                                <input type="number" name="fingerprint_id"
                                    placeholder="Misal: 12" required value="{{ old('fingerprint_id') }}"
                                    style="font-weight:700; color:var(--blue-primary);">
                            </div>
                            @error('fingerprint_id')
                                <div class="field-error">{{ $message }}</div>
                            @enderror
                            <div class="form-hint">Masukkan angka unik identitas yang didaftarkan pada alat sensor sidik jari.</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="input-group-web">
                                ...
                                <input type="number" name="no_hp_ortu"
                                    placeholder="81234567890" required value="{{ old('no_hp_ortu') }}">
                            </div>
            ...
            <div class="col-12 dashboard-wrapper p-0">
                ...
                <div class="px-3">
                    ...
                    <form action="{{ route('mahasiswa.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="mobile-form-label">NIM <span class="text-danger">*</span></label>
                            <input type="number" name="nim" class="mobile-form-control form-control"
                                placeholder="Contoh: 2025001" required value="{{ old('nim') }}">
                        </div>
                        ...
                        <div class="hardware-setup-box-mobile">
                            <h6 class="fw-bold mb-3" style="color:#1a56db; font-size:14px;">
                                <i class="fas fa-microchip me-2"></i> Konfigurasi Sistem & Notifikasi
                            </h6>

                            <div class="mb-3">
                                <label class="mobile-form-label">ID Fingerprint <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0">
                                        <i class="fas fa-fingerprint" style="color:#1a56db;"></i>
                                    </span>
                                    <input type="number" name="fingerprint_id"
                                        class="form-control border-start-0 ps-0 fw-bold @error('fingerprint_id') is-invalid @enderror"
                                        style="color:#1a56db;" placeholder="Misal: 12"
                                        required value="{{ old('fingerprint_id') }}">
                                    @error('fingerprint_id')
                                        <div class="invalid-feedback fw-bold">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-text small mt-1">Masukkan angka unik identitas dari alat sensor sidik jari.</div>
                            </div>
